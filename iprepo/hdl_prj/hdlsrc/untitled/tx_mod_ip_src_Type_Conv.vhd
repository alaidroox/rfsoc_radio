-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_src_Type_Conv.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_src_Type_Conv
-- Source Path: untitled/Modulation/Type Conv
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tx_mod_ip_src_Type_Conv IS
...
END tx_mod_ip_src_Type_Conv;


ARCHITECTURE rtl OF tx_mod_ip_src_Type_Conv IS
