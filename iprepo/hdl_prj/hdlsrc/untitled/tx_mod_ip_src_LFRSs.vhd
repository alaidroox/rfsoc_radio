-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_src_LFRSs.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_src_LFRSs
-- Source Path: untitled/Modulation/Signal Generator/Random Generator/LFRSs
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END tx_mod_ip_src_LFRSs;


ARCHITECTURE rtl OF tx_mod_ip_src_LFRSs IS

  -- Component Declarations
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inportReset                     :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inportReset                     :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inportReset                     :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inportReset                     :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inportReset                     :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inportReset                     :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inportReset                     :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inportReset                     :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_src_PN_Sequence_Generator9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inportReset                     :   IN    std_logic;
  ...
  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator(rtl);

  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator1
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator1(rtl);

  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator2
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator2(rtl);

  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator3
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator3(rtl);

  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator4
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator4(rtl);

  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator5
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator5(rtl);

  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator6
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator6(rtl);

  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator7
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator7(rtl);

  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator8
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator8(rtl);

  FOR ALL : tx_mod_ip_src_PN_Sequence_Generator9
    USE ENTITY work.tx_mod_ip_src_PN_Sequence_Generator9(rtl);
...
BEGIN
  u_PN_Sequence_Generator : tx_mod_ip_src_PN_Sequence_Generator
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
  ...
  u_PN_Sequence_Generator1 : tx_mod_ip_src_PN_Sequence_Generator1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
  ...
  u_PN_Sequence_Generator2 : tx_mod_ip_src_PN_Sequence_Generator2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
  ...
  u_PN_Sequence_Generator3 : tx_mod_ip_src_PN_Sequence_Generator3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
  ...
  u_PN_Sequence_Generator4 : tx_mod_ip_src_PN_Sequence_Generator4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
  ...
  u_PN_Sequence_Generator5 : tx_mod_ip_src_PN_Sequence_Generator5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
  ...
  u_PN_Sequence_Generator6 : tx_mod_ip_src_PN_Sequence_Generator6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
  ...
  u_PN_Sequence_Generator7 : tx_mod_ip_src_PN_Sequence_Generator7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
  ...
  u_PN_Sequence_Generator8 : tx_mod_ip_src_PN_Sequence_Generator8
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
  ...
  u_PN_Sequence_Generator9 : tx_mod_ip_src_PN_Sequence_Generator9
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              inportReset => Reset_1,
