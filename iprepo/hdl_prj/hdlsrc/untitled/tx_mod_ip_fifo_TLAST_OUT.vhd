-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_fifo_TLAST_OUT
-- Source Path: tx_mod_ip/tx_mod_ip_axi4_stream_master/tx_mod_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tx_mod_ip_fifo_TLAST_OUT IS
...
END tx_mod_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF tx_mod_ip_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT tx_mod_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : tx_mod_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.tx_mod_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_tx_mod_ip_fifo_TLAST_OUT_classic_ram_singlebit : tx_mod_ip_SimpleDualPortRAM_singlebit
