-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_src_complement_re1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_src_complement_re1
-- Source Path: untitled/Modulation/Signal Generator/Variable Modulator/QAM1024 Generator/complement_re1
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tx_mod_ip_src_complement_re1 IS
  PORT( d_in                              :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        d_out                             :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END tx_mod_ip_src_complement_re1;


ARCHITECTURE rtl OF tx_mod_ip_src_complement_re1 IS
