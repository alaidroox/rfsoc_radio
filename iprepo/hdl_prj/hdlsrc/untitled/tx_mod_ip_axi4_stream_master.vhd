-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_axi4_stream_master
-- Source Path: tx_mod_ip/tx_mod_ip_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tx_mod_ip_axi4_stream_master IS
...
END tx_mod_ip_axi4_stream_master;


ARCHITECTURE rtl OF tx_mod_ip_axi4_stream_master IS

  -- Component Declarations
  COMPONENT tx_mod_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT tx_mod_ip_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : tx_mod_ip_fifo_data_OUT
    USE ENTITY work.tx_mod_ip_fifo_data_OUT(rtl);

  FOR ALL : tx_mod_ip_fifo_TLAST_OUT
    USE ENTITY work.tx_mod_ip_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_tx_mod_ip_fifo_data_OUT_inst : tx_mod_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_tx_mod_ip_fifo_TLAST_OUT_inst : tx_mod_ip_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
