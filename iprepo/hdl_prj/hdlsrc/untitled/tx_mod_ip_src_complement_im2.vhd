-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_src_complement_im2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_src_complement_im2
-- Source Path: untitled/Modulation/Signal Generator/Variable Modulator/QAM512 Generator/complement_im2
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tx_mod_ip_src_complement_im2 IS
  PORT( d_in                              :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        d_out                             :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END tx_mod_ip_src_complement_im2;


ARCHITECTURE rtl OF tx_mod_ip_src_complement_im2 IS
