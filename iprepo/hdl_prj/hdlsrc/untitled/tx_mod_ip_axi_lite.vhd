-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_axi_lite.vhd
-- Created: 2023-02-16 13:58:24
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_axi_lite
-- Source Path: tx_mod_ip/tx_mod_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END tx_mod_ip_axi_lite;


ARCHITECTURE rtl OF tx_mod_ip_axi_lite IS

  -- Component Declarations
  COMPONENT tx_mod_ip_addr_decoder
  ...
  COMPONENT tx_mod_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : tx_mod_ip_addr_decoder
    USE ENTITY work.tx_mod_ip_addr_decoder(rtl);

  FOR ALL : tx_mod_ip_axi_lite_module
    USE ENTITY work.tx_mod_ip_axi_lite_module(rtl);
...
BEGIN
  u_tx_mod_ip_addr_decoder_inst : tx_mod_ip_addr_decoder
  ...
  u_tx_mod_ip_axi_lite_module_inst : tx_mod_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
