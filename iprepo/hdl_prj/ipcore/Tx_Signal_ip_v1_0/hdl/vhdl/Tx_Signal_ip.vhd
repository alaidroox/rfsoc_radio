-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Tx_Signal\Tx_Signal_ip.vhd
...
ARCHITECTURE rtl OF Tx_Signal_ip IS

  -- Component Declarations
  COMPONENT Tx_Signal_ip_reset_sync
  ...
  COMPONENT Tx_Signal_ip_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(7 DOWNTO 0);  -- ufix8
  ...
  COMPONENT Tx_Signal_ip_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : Tx_Signal_ip_reset_sync
    USE ENTITY work.Tx_Signal_ip_reset_sync(rtl);

  FOR ALL : Tx_Signal_ip_axi4_stream_slave
    USE ENTITY work.Tx_Signal_ip_axi4_stream_slave(rtl);

  FOR ALL : Tx_Signal_ip_dut
    USE ENTITY work.Tx_Signal_ip_dut(rtl);

  FOR ALL : Tx_Signal_ip_axi4_stream_master
    USE ENTITY work.Tx_Signal_ip_axi4_stream_master(rtl);
...
BEGIN
  u_Tx_Signal_ip_reset_sync_inst : Tx_Signal_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset
              );

  u_Tx_Signal_ip_axi4_stream_slave_inst : Tx_Signal_ip_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_Tx_Signal_ip_dut_inst : Tx_Signal_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => dut_enable,  -- ufix1
              modulation => modulation,  -- ufix16
              enable_tx => enable_tx,  -- ufix1
              enable_data => enable_data,  -- ufix1
              s_tdata => top_user_data,  -- ufix8
  ...
  u_Tx_Signal_ip_axi4_stream_master_inst : Tx_Signal_ip_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  s_tlast_sig <= top_user_TLAST;

  s_tvalid_sig <= top_user_valid_1;

  top_user_ready <= s_tready_sig;
