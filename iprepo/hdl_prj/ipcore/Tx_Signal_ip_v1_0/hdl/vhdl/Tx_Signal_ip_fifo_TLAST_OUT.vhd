-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Tx_Signal\Tx_Signal_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Tx_Signal_ip_fifo_TLAST_OUT
-- Source Path: Tx_Signal_ip/Tx_Signal_ip_axi4_stream_master/Tx_Signal_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Tx_Signal_ip_fifo_TLAST_OUT IS
...
END Tx_Signal_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF Tx_Signal_ip_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT Tx_Signal_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : Tx_Signal_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.Tx_Signal_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_Tx_Signal_ip_fifo_TLAST_OUT_classic_ram_singlebit : Tx_Signal_ip_SimpleDualPortRAM_singlebit
