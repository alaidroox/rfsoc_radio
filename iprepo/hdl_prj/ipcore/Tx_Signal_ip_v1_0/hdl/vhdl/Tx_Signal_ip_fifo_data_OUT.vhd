-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Tx_Signal\Tx_Signal_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Tx_Signal_ip_fifo_data_OUT
-- Source Path: Tx_Signal_ip/Tx_Signal_ip_axi4_stream_master/Tx_Signal_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Tx_Signal_ip_fifo_data_OUT IS
...
END Tx_Signal_ip_fifo_data_OUT;


ARCHITECTURE rtl OF Tx_Signal_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT Tx_Signal_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : Tx_Signal_ip_SimpleDualPortRAM_generic
    USE ENTITY work.Tx_Signal_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_Tx_Signal_ip_fifo_data_OUT_classic_ram_generic : Tx_Signal_ip_SimpleDualPortRAM_generic
