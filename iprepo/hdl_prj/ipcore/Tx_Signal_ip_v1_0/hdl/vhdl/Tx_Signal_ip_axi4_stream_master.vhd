-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Tx_Signal\Tx_Signal_ip_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Tx_Signal_ip_axi4_stream_master
-- Source Path: Tx_Signal_ip/Tx_Signal_ip_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Tx_Signal_ip_axi4_stream_master IS
...
END Tx_Signal_ip_axi4_stream_master;


ARCHITECTURE rtl OF Tx_Signal_ip_axi4_stream_master IS

  -- Component Declarations
  COMPONENT Tx_Signal_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT Tx_Signal_ip_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : Tx_Signal_ip_fifo_data_OUT
    USE ENTITY work.Tx_Signal_ip_fifo_data_OUT(rtl);

  FOR ALL : Tx_Signal_ip_fifo_TLAST_OUT
    USE ENTITY work.Tx_Signal_ip_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_Tx_Signal_ip_fifo_data_OUT_inst : Tx_Signal_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Tx_Signal_ip_fifo_TLAST_OUT_inst : Tx_Signal_ip_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
