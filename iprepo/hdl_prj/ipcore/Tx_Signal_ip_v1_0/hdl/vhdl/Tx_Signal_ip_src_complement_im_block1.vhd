-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Tx_Signal\Tx_Signal_ip_src_complement_im_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Tx_Signal_ip_src_complement_im_block1
-- Source Path: Tx_Signal/Tx_Signal/Modulation/Signal Generator/Variable Modulator/QAM32 Generator/complement_im
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Tx_Signal_ip_src_complement_im_block1 IS
  PORT( d_in                              :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        d_out                             :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END Tx_Signal_ip_src_complement_im_block1;


ARCHITECTURE rtl OF Tx_Signal_ip_src_complement_im_block1 IS
