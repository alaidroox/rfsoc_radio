-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Tx_Signal\Tx_Signal_ip_fifo_TLAST.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Tx_Signal_ip_fifo_TLAST
-- Source Path: Tx_Signal_ip/Tx_Signal_ip_axi4_stream_slave/Tx_Signal_ip_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Tx_Signal_ip_fifo_TLAST IS
...
END Tx_Signal_ip_fifo_TLAST;


ARCHITECTURE rtl OF Tx_Signal_ip_fifo_TLAST IS
...
BEGIN
  ...
  u_Tx_Signal_ip_fifo_TLAST_classic_ram : Tx_Signal_ip_SimpleDualPortRAM_singlebit
