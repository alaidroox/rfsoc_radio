-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Tx_Signal\Tx_Signal_ip_src_complement_im_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Tx_Signal_ip_src_complement_im_block
-- Source Path: Tx_Signal/Tx_Signal/Modulation/Signal Generator/Variable Modulator/QAM256 Generator/complement_im
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Tx_Signal_ip_src_complement_im_block IS
  PORT( d_in                              :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        d_out                             :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END Tx_Signal_ip_src_complement_im_block;


ARCHITECTURE rtl OF Tx_Signal_ip_src_complement_im_block IS
