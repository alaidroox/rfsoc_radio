-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_src_QAM256_Generator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_src_QAM256_Generator
-- Source Path: untitled/Modulation/Signal Generator/Variable Modulator/QAM256 Generator
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tx_mod_ip_src_QAM256_Generator IS
...
END tx_mod_ip_src_QAM256_Generator;


ARCHITECTURE rtl OF tx_mod_ip_src_QAM256_Generator IS

  -- Component Declarations
  COMPONENT tx_mod_ip_src_complement_re_block
    PORT( d_in                            :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          d_out                           :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
          );
  END COMPONENT;

  COMPONENT tx_mod_ip_src_complement_im_block
    PORT( d_in                            :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          d_out                           :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
          );
  END COMPONENT;
  ...
  FOR ALL : tx_mod_ip_src_complement_re_block
    USE ENTITY work.tx_mod_ip_src_complement_re_block(rtl);

  FOR ALL : tx_mod_ip_src_complement_im_block
    USE ENTITY work.tx_mod_ip_src_complement_im_block(rtl);
