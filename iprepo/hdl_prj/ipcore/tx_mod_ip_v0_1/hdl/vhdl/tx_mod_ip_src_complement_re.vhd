-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_src_complement_re.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_src_complement_re
-- Source Path: untitled/Modulation/Signal Generator/Variable Modulator/QAM128 Generator/complement_re
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tx_mod_ip_src_complement_re IS
  PORT( d_in                              :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        d_out                             :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END tx_mod_ip_src_complement_re;


ARCHITECTURE rtl OF tx_mod_ip_src_complement_re IS
