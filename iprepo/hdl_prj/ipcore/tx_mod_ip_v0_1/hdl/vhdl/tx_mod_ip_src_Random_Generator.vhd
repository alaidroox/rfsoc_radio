-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_src_Random_Generator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_src_Random_Generator
-- Source Path: untitled/Modulation/Signal Generator/Random Generator
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tx_mod_ip_src_Random_Generator IS
...
END tx_mod_ip_src_Random_Generator;


ARCHITECTURE rtl OF tx_mod_ip_src_Random_Generator IS

  -- Component Declarations
  COMPONENT tx_mod_ip_src_LFRSs
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Reset_1                         :   IN    std_logic;
  ...
  FOR ALL : tx_mod_ip_src_LFRSs
    USE ENTITY work.tx_mod_ip_src_LFRSs(rtl);
