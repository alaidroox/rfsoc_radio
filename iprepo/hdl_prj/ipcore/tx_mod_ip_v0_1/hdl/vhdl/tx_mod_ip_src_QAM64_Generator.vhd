-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\untitled\tx_mod_ip_src_QAM64_Generator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: tx_mod_ip_src_QAM64_Generator
-- Source Path: untitled/Modulation/Signal Generator/Variable Modulator/QAM64 Generator
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY tx_mod_ip_src_QAM64_Generator IS
...
END tx_mod_ip_src_QAM64_Generator;


ARCHITECTURE rtl OF tx_mod_ip_src_QAM64_Generator IS

  -- Component Declarations
  COMPONENT tx_mod_ip_src_complement_re_block3
    PORT( d_in                            :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          d_out                           :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
          );
  END COMPONENT;

  COMPONENT tx_mod_ip_src_complement_im_block2
    PORT( d_in                            :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          d_out                           :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
          );
  END COMPONENT;
  ...
  FOR ALL : tx_mod_ip_src_complement_re_block3
    USE ENTITY work.tx_mod_ip_src_complement_re_block3(rtl);

  FOR ALL : tx_mod_ip_src_complement_im_block2
    USE ENTITY work.tx_mod_ip_src_complement_im_block2(rtl);
...
BEGIN
  u_complement_re : tx_mod_ip_src_complement_re_block3
    PORT MAP( d_in => std_logic_vector(Multiport_Switch_out1),  -- sfix16_En14
              d_out => complement_re_out1  -- sfix16_En14
              );

  u_complement_im : tx_mod_ip_src_complement_im_block2
